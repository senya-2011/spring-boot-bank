...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiDefinition.RegisterRequest();
  });
  ...
  describe('RegisterRequest', function() {
    it('should create an instance of RegisterRequest', function() {
      ...
      //var instance = new OpenApiDefinition.RegisterRequest();
      //expect(instance).to.be.a(OpenApiDefinition.RegisterRequest);
    });
